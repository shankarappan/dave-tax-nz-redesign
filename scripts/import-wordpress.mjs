...
const classifications = {
  ...
  "nz-crypto-tax-disposals": { subject: "Crypto Tax", relationship: "Written by Dave Ananth; republished from Interest.co.nz", sourceUrl: "https://www.interest.co.nz/personal-finance/139687/dave-ananth-points-out-crypto-disposals-trigger-income-tax-any-profits-each" },
  "overseas-student-loan-default-deal": { subject: "Student Loans", relationship: "Republished with commentary and analysis by Dave Ananth", sourceUrl: "https://www.stuff.co.nz/nz-news/361012265/doctors-180000-student-loan-standoff-ends-deal" },
  "ird-statutory-demand-critical-10-day-guide": { subject: "IRD Tax Debt" },
  "nz-student-loan-border-arrest": { subject: "Student Loans", internalSlug: "student-loan-border-arrest", relationship: "Republished with commentary and analysis by Dave Ananth", sourceUrl: "https://www.stuff.co.nz/nz-news/360997679/doctor-built-life-overseas-now-hes-been-arrested-airport-over-180000-student-loan-debt" },
  "gst-as-working-capital-critical-ird-fix": { subject: "IRD Tax Debt", relationship: "Written by Dave Ananth; republished from Interest.co.nz", sourceUrl: "https://www.interest.co.nz/business/139325/gst-becoming-working-capital-why-earlier-intervention-could-save-viable-businesses", legacyAliases: ["https://davetaxnz.nz/2026/07/11/https-davetaxnz-nz-articles-advice-gst-as-working-capital/"] },
  ...
  "ird-fails-to-communicate-student-loan-interest-rate-changes-to-kiwis-living-abroad": { subject: "Student Loans", type: "Media Interviews", publication: "Te Waha Nui", relationship: "Interview with Dave Ananth", sourceUrl: "https://tewahanui.nz/politics/ird-fails-to-communicate-student-loan-interest-rate-changes-to-kiwis-living-abroad" },
  ...
  "tax-debt-enforcement-timing": { subject: "IRD Tax Debt", relationship: "Written by Dave Ananth; republished from Interest.co.nz", sourceUrl: "https://www.interest.co.nz/personal-finance/137242/dave-ananth-reports-ird-systems-prioritise-tax-debt-enforcement-even" },
